...
select
	...
	const.contype as column_key, c.column_default, c.is_nullable, const.constraint_name, const.REFERENCED_TABLE_NAME, const.REFERENCED_COLUMN_NAME, const.condef
from information_schema.columns c
	left join (
		SELECT rel.relname as table_name, con.conname as constraint_name, con.contype,
		  ...
		  ,a.attname as column_name, relf.relname as REFERENCED_TABLE_NAME, af.attname as REFERENCED_COLUMN_NAME
...
select s.sequencename as sequence_name, s.start_value, s.min_value, s.max_value, 
    ...
    public DbModel getDbModel() {
		...
		try(
			...
			while (srs.next()) {
				...
				DbSequence seq = DbSequence.builder().name(sequenceName)
